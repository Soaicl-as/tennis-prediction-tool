...
```bash
git remote add encore encore://tennis-prediction-tool-bdm2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/tennis-prediction-tool-bdm2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/tennis-prediction-tool-bdm2/settings/integrations/github)
